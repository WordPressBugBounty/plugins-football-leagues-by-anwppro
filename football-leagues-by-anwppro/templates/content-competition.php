				...
				if ( $is_multistage ) :
					...
					<div class="anwp-section">
						...
						anwp_football_leagues()->load_partial(
							[
								'text'  => $competition_row['stage_title'] ?? '',
								'class' => 'competition__stage-title',
							],
							'general/header'
						);
						?>
							...
							if ( apply_filters( 'anwpfl/tmpl-competition/render_group_title', $render_group_title, $group, $competition, $competition_post_id ) ) :
								...
								<div class="competition__group-title">
									...
									anwp_football_leagues()->load_partial(
										[
											'text'  => $group->title,
											'class' => 'competition__title-group',
										],
										'general/subheader'
									);
									?>
									...
									<div class="anwp-section">
										...
										anwp_football_leagues()->load_partial(
											[
												...
												'class' => 'competition__round-title competition__matchweek-title',
											],
											'general/subheader'
										);
										?>
