	...
	<div class="d-flex my-1">
		...
		<div class="anwp-flex-1 anwp-text-center anwp-min-width-0 match-card__club-wrapper">
			<?php if ( $data->club_home_logo ) : ?>
				<img loading="lazy" width="45" height="45" class="match-card__club-logo anwp-object-contain match-simple__team-logo anwp-flex-none mx-auto anwp-w-45 anwp-h-45"
