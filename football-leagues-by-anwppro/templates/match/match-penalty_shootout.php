...
if ( empty( $data['parsed_events']['penalty_shootout'] ) ) {
	return '';
}
...
<div class="match-penalty-shootout anwp-section">
	...
	*/
	...
	foreach ( $data['parsed_events']['penalty_shootout'] as $e_index => $e ) :
				...
				<?php if ( $e->club === (int) $data['home_club'] ) : ?>
					<div class="match__event-icon mx-2 anwp-flex-none anwp-leading-1">
						<svg class="icon__ball">
							<use href="#<?php echo esc_attr( 'yes' === $e->scored ? 'icon-ball_penalty' : 'icon-ball_canceled' ); ?>"></use>
						</svg>
					</div>
