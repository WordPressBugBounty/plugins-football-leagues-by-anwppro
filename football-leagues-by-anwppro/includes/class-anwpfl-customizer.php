...
class AnWPFL_Customizer {
	...
	public function register_customizer_settings( $wp_customize ) {
		...
		*/
		$wp_customize->add_setting(
			'anwp-fl-customizer[general][flags]',
			[
				'default' => 'circle',
				'type'    => 'option',
			]
		...
		$wp_customize->add_control(
			...
			[
				'type'     => 'select',
				'label'    => esc_html__( 'Flags', 'anwp-football-leagues' ),
				'section'  => 'fl_general',
				'settings' => 'anwp-fl-customizer[general][flags]',
				'choices'  => [
					'circle' => __( 'Circle', 'anwp-football-leagues' ),
					'legacy' => __( 'Legacy', 'anwp-football-leagues' ),
				],
			]
		);
		...
		*/
		$wp_customize->add_setting(
			'anwp-fl-customizer[player][current_team]',
			[
				'default' => '',
				'type'    => 'option',
			]
		...
		$wp_customize->add_control(
			...
			[
				'type'     => 'select',
				'label'    => esc_html__( 'Current Team', 'anwp-football-leagues' ),
				'section'  => 'fl_player',
