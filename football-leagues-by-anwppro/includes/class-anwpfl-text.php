...
class AnWPFL_Text {
	...
	public function add_config_page_metabox() {
		...
		$cmb->add_field(
			[
				'name' => esc_html__( 'Match Cancelled', 'anwp-football-leagues' ),
				'desc' => 'match :: header',
				'id'   => 'match__match__match_cancelled',
				'type' => 'anwp_fl_text',
			]
		);
		...
		$cmb->add_field(
			[
				'name' => esc_html__( 'All Seasons', 'anwp-football-leagues' ),
				'desc' => 'general :: all seasons',
				'id'   => 'general__all_seasons',
				'type' => 'anwp_fl_text',
			]
		);
		...
		$cmb->add_field(
			[
				'name' => esc_html__( 'Load More', 'anwp-football-leagues' ),
				'desc' => 'general :: load more',
